...
import { Package, Warehouse, Truck, CheckCircle2, Clock } from "lucide-react";
...
const stages = [
  ...
  { key: "in_warehouse", label: "In Warehouse", icon: Warehouse, colorClass: "text-warning" },
  { key: "out_for_delivery", label: "Out for Delivery", icon: Truck, colorClass: "text-pickup" },
